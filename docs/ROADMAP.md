...
- **Stability & compatibility:** The bundle is compatible with **Symfony 7.4+ and 8**, Doctrine DBAL 2.x/3.x/4.x, and doctrine/migrations 3.x/4.x. Fix regressions and deprecations as they appear.
...
- **Demos:** Keep **demo/symfony8** working and referenced from the docs.
...
- **Demos:** Symfony 8 with example migrations using the bundle.
