...
- **Contributors / maintainers** — The Symfony 7 demo (`demo/symfony7`) has been removed. Use `demo/symfony8` (`make demo-up-symfony8`, `make up-symfony8`). Make targets and docs that mentioned Symfony 7 demos now refer only to Symfony 8.
- **Package consumers** — No action required; demos are not shipped in the Composer package.
