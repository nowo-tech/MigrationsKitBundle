# Migrations Kit Bundle – Demo (Symfony 6)
...
Starts the container and runs migrations. Open http://localhost:8006 (or `$PORT`). The bundle is mounted at `/var/migrations-kit-bundle` in the container.
...
**From the bundle root:** `make demo-up-symfony6` then `make demo-migrate-symfony6`.
