...
- ✅ **MigrationDefinitionKeys** — constants for definition keys (`tables`, `columns`, `data`, `insert`, `update`, `primary_key`, `indexes`, etc.), Doctrine Types style; use alias **MDK** in code; see [USAGE.md](docs/USAGE.md#migrationdefinitionkeys-standard-keys)
